...
The complete working example is available in the [Rap-Wrapper-Notebook-Example.ipynb](./Rap-Wrapper-Notebook-Example.ipynb) notebook. The following walkthrough extracts its key components.
